...
from PyQt5.QtWidgets import QTableWidgetItem, QFileDialog, QPushButton, QMessageBox, QFrame
...
class core:
    ...
    def restart():
        #eapp = os.getcwd()
        os.chdir(r"F:\_Major Project PyPASS\project_env\main-Code")
        os.execl(sys.executable, 'python', "pypass.py", *sys.argv[1:]) 
        sys.exit()
        return None 
