...
class Ui_MainMenu(object):
    def setupUi(self, MainMenu):
        ...
        self.pushButton_search.setGeometry(QtCore.QRect(240, 30, 111, 51))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.lineSearch.setFont(font)
        self.pushButton_search.setFocusPolicy(QtCore.Qt.WheelFocus)
        self.pushButton_search.setStyleSheet(u"background:rgb(40, 44, 52);color: white;")
        ...
        self.pushButton_showall.setStyleSheet(u"background:rgb(40, 44, 52);color: white;")
        ...
        self.pushButton_create.setStyleSheet(u"background:rgb(189, 147, 249);color: black;") #85, 170, 255
        ...
        self.pushButton_delete.setStyleSheet(u"background:rgb(189, 147, 249);color: black;")
        ...
        self.pushButton_config.setStyleSheet(u"background:rgb(189, 147, 249);color: black;")
        ...
        self.pushButton_exit.setStyleSheet(u"background:rgb(40, 44, 52);color: white;")
        ...
        self.optionlabel.setGeometry(QtCore.QRect(430, 38, 200, 31))        
        font = QtGui.QFont()
        ...
        self.msg_status = QtWidgets.QLabel(MainMenu)   
        self.msg_status.setGeometry(QtCore.QRect(20, 5, 200, 31))        
        font = QtGui.QFont()
        font.setPointSize(9)
        self.msg_status.setFont(font)
        self.msg_status.setAlignment(QtCore.Qt.AlignLeft)
        self.msg_status.setWordWrap(True)
        self.msg_status.setObjectName("msg_status")

        self.msg_label = QtWidgets.QLabel(MainMenu)
        self.msg_label.setGeometry(QtCore.QRect(82, 3, 981, 31))
        ...
        self.msg_label.setStyleSheet("color:rgb(220,20,60);")
        self.msg_label.setAlignment(QtCore.Qt.AlignLeft)
        self.msg_label.setWordWrap(True)
        self.msg_label.setOpenExternalLinks(True)
        self.msg_label.setObjectName("msg_label")           
        self.label_copy = QtWidgets.QLabel(MainMenu)
        self.label_copy.setGeometry(QtCore.QRect(82, 750, 991, 16))
    ...
    def retranslateUi(self, MainMenu):
        ...
        self.label_copy.setText(_translate("MainMenu", "Copyright © PyPASS 2022 - Major Project (KIIT University)"))
        self.msg_status.setText(_translate("MainMenu", "STATUS: "))
