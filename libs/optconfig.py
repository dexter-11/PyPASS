...
class Ui_Options(object):
    def setupUi(self, Options):
        ...
        self.pushButtonExcel.setStyleSheet(u"background:rgb(248,248,255);color: black;")
        ...
        self.pushButtonBackup.setStyleSheet(u"background:rgb(248,248,255);color: black;")
        ...
        self.pushButtonRemoveDB.setStyleSheet(u"background:rgb(248,248,255);color: black;")
        ...
        self.pushButtonImport.setStyleSheet(u"background:rgb(248,248,255);color: black;")
        self.pushButtonImport.setObjectName("pushButtonImport")
        self.lineOldPass = QtWidgets.QLineEdit(Options)
        self.lineOldPass.setGeometry(QtCore.QRect(170, 330, 201, 21))
        ...
        self.lineNewPass.setGeometry(QtCore.QRect(170, 370, 201, 21))
        ...
        self.label_Oldpwd.setGeometry(QtCore.QRect(20, 330, 141, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_Newpwd.setGeometry(QtCore.QRect(20, 370, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_Reset.setGeometry(QtCore.QRect(100, 290, 251, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_Reset.setFont(font)
        self.label_Reset.setStyleSheet(u"color:rgb(220,20,60);")
        self.label_Reset.setObjectName("label_Reset")
        self.pushButtonResetAdmin = QtWidgets.QPushButton(Options)
        self.pushButtonResetAdmin.setGeometry(QtCore.QRect(270, 400, 101, 31))
        self.pushButtonResetAdmin.setFocusPolicy(QtCore.Qt.WheelFocus)
        self.pushButtonResetAdmin.setStyleSheet(u"background:rgb(245,245,245);color: black;")
        self.pushButtonResetAdmin.setObjectName("pushButtonResetAdmin")
        self.pushSaveExit = QtWidgets.QPushButton(Options)
        self.pushSaveExit.setGeometry(QtCore.QRect(110, 455, 181, 51))
        self.pushSaveExit.setFocusPolicy(QtCore.Qt.WheelFocus)
        self.pushSaveExit.setStyleSheet(u"background:rgb(40, 44, 52);color: white;")
    ...
    def excel(self):
        ...
        try:
            ...
            exportxls = "PyPASS_{}-{}-{}.xls".format(date[3],date[2], date[1])
    ...
    def backup(self):
        ...
        try:            
            date = core.now()
            home = os.path.expanduser('~')
            backup_file = "PyPASS_{}-{}-{}.zip".format(date[3],date[2], date[1])        
